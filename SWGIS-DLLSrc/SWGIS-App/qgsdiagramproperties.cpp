    ...
    , mMapCanvas( canvas )
{
  ...
  myDa.setEllipsoidalMode( SWGISApp::instance()->mapCanvas()->mapSettings().hasCrsTransformEnabled() );
...
void QgsDiagramProperties::apply()
{
  ...
  {
    SWGISApp::instance()->messageBar()->pushMessage(
