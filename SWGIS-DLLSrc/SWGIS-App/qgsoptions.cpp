...
#include "qgsdialog.h"
#include "./composer/qgscomposer.h"
    ...
    mSettings( nullptr )
{
  ...
  // stylesheet setup
  mStyleSheetBuilder = SWGISApp::instance()->styleSheetBuilder();
  ...
  cbxAutoTransaction->setChecked( SWGISApp::instance()->autoTransaction() );
...
{
  SWGISApp::instance()->setIconSizes( iconSize.toInt() );
}
...
void QgsOptions::saveOptions()
{
  ...
  SWGISApp::instance()->setAutoTransaction( cbxAutoTransaction->isChecked() );
      ...
      ( mSettings->value( "/qgis/newProjectDefault" ).toBool() != cbxProjectDefaultNew->isChecked() ) )
  {
    ...
    SWGISApp::instance()->updateProjectFromTemplates();
  }
