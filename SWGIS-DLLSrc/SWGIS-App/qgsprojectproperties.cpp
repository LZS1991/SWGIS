...
void QgsProjectProperties::apply()
{
  ...
  SWGISApp::instance()->mapOverviewCanvas()->setBackgroundColor( myColor );
  SWGISApp::instance()->mapOverviewCanvas()->refresh();
...
{
    //LZS2851
//  QSet<QgsComposer*> projectComposers = SWGISApp::instance()->printComposers();
//  QStringList composerTitles;
...
void QgsProjectProperties::on_pbnLaunchOWSChecker_clicked()
{
  ...
  checkOWS( SWGISApp::instance()->layerTreeView()->layerTreeModel()->rootGroup(), owsNames, encodingMessages );
