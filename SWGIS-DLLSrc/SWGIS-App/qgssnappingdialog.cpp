    ...
    , mDock( nullptr )
{
  ...
  if ( myDockFlag )
  {
    mDock = new QgsSnappingDock( tr( "Snapping and Digitizing Options" ), SWGISApp::instance() );
    mDock->setAllowedAreas( Qt::BottomDockWidgetArea | Qt::TopDockWidgetArea );
    mDock->setWidget( this );
    connect( this, SIGNAL( destroyed() ), mDock, SLOT( close() ) );
    SWGISApp::instance()->addDockWidget( Qt::BottomDockWidgetArea, mDock );
  ...
  connect( SWGISApp::instance(), SIGNAL( newProject() ), this, SLOT( initNewProject() ) );
  connect( SWGISApp::instance(), SIGNAL( projectRead() ), this, SLOT( reload() ) );
}
