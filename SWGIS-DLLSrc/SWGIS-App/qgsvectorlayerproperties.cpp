    ...
    , mFieldsPropertiesDialog( nullptr )
{
  ...
  if ( mLayer->hasGeometryType() )
  {
    ...
    layout->setMargin( 0 );
    labelingDialog = new QgsLabelingWidget( mLayer, SWGISApp::instance()->mapCanvas(), labelingFrame );
  ...
  connect( this, SIGNAL( toggleEditing( QgsMapLayer* ) ), SWGISApp::instance(), SLOT( toggleEditing( QgsMapLayer* ) ) );
...
void QgsVectorLayerProperties::insertExpression()
{
  ...
  << QgsExpressionContextUtils::mapSettingsScope( SWGISApp::instance()->mapCanvas()->mapSettings() )
...
void QgsVectorLayerProperties::syncToLayer()
{
  ...
  mScaleRangeWidget->setMapCanvas( SWGISApp::instance()->mapCanvas() );
...
void QgsVectorLayerProperties::updateSymbologyPage()
{
  ...
  if ( mLayer->rendererV2() )
  {
    ...
    mRendererDialog->setMapCanvas( SWGISApp::instance()->mapCanvas() );
