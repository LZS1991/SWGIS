...
#include "../../../SWGIS-Inc/SWGIS-Core/qgsmessageoutput.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMessageOutputConsole_t, stringdata) + ofs \
...
void QgsMessageOutputConsole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QgsMessageOutputConsole::destroyed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QgsMessageOutputConsole::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsMessageOutputConsole.data,
      qt_meta_data_QgsMessageOutputConsole,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsMessageOutputConsole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMessageOutputConsole.stringdata))
