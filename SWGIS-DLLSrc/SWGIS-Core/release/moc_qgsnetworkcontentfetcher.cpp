...
#include "../../../SWGIS-Inc/SWGIS-Core/qgsnetworkcontentfetcher.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsNetworkContentFetcher_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 35, 13), // "contentLoaded"
QT_MOC_LITERAL(4, 49, 2) // "ok"
...
void QgsNetworkContentFetcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->contentLoaded((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->contentLoaded(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QgsNetworkContentFetcher::finished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QgsNetworkContentFetcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsNetworkContentFetcher.data,
      qt_meta_data_QgsNetworkContentFetcher,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsNetworkContentFetcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsNetworkContentFetcher.stringdata))
        return static_cast<void*>(const_cast< QgsNetworkContentFetcher*>(this));
