...
#include "../../../SWGIS-Inc/SWGIS-Core/qgsnetworkdiskcache.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsNetworkDiskCache_t, stringdata) + ofs \
...
const QMetaObject QgsNetworkDiskCache::staticMetaObject = {
    { &QNetworkDiskCache::staticMetaObject, qt_meta_stringdata_QgsNetworkDiskCache.data,
      qt_meta_data_QgsNetworkDiskCache,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsNetworkDiskCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsNetworkDiskCache.stringdata))
        return static_cast<void*>(const_cast< QgsNetworkDiskCache*>(this));
