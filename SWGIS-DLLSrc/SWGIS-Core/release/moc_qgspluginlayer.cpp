...
#include "../../../SWGIS-Inc/SWGIS-Core/qgspluginlayer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsPluginLayer_t, stringdata) + ofs \
...
const QMetaObject QgsPluginLayer::staticMetaObject = {
    { &QgsMapLayer::staticMetaObject, qt_meta_stringdata_QgsPluginLayer.data,
      qt_meta_data_QgsPluginLayer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsPluginLayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsPluginLayer.stringdata))
        return static_cast<void*>(const_cast< QgsPluginLayer*>(this));
