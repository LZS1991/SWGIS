...
#include "../../../SWGIS-Inc/SWGIS-Core/qgstransaction.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsTransaction_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 15), // "onLayersDeleted"
QT_MOC_LITERAL(4, 46, 8) // "layerids"

    },
    "QgsTransaction\0afterRollback\0\0"
    "onLayersDeleted\0layerids"
};
...
void QgsTransaction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onLayersDeleted((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QgsTransaction::afterRollback)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QgsTransaction::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsTransaction.data,
      qt_meta_data_QgsTransaction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsTransaction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsTransaction.stringdata))
        return static_cast<void*>(const_cast< QgsTransaction*>(this));
