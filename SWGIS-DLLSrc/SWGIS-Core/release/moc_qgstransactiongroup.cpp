...
#include "../../../SWGIS-Inc/SWGIS-Core/qgstransactiongroup.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsTransactionGroup_t, stringdata) + ofs \
...
void QgsTransactionGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QgsTransactionGroup::commitError)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QgsTransactionGroup::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QgsTransactionGroup.data,
      qt_meta_data_QgsTransactionGroup,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsTransactionGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsTransactionGroup.stringdata))
        return static_cast<void*>(const_cast< QgsTransactionGroup*>(this));
