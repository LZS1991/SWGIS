...
#include "../../../SWGIS-Inc/SWGIS-Core/gps/qextserialport/qwineventnotifier.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWinEventNotifier_t, stringdata) + ofs \
...
void QWinEventNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QWinEventNotifier::*_t)(HANDLE );
...
void *QWinEventNotifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QWinEventNotifier.stringdata))
