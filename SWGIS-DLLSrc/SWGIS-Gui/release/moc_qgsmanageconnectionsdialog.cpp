...
#include "../../../SWGIS-Inc/SWGIS-Gui/qgsmanageconnectionsdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsManageConnectionsDialog_t, stringdata) + ofs \
...
const QMetaObject QgsManageConnectionsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QgsManageConnectionsDialog.data,
      qt_meta_data_QgsManageConnectionsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsManageConnectionsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsManageConnectionsDialog.stringdata))
        return static_cast<void*>(const_cast< QgsManageConnectionsDialog*>(this));
