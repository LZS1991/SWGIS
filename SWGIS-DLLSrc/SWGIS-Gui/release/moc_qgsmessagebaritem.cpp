...
#include "../../../SWGIS-Inc/SWGIS-Gui/qgsmessagebaritem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMessageBarItem_t, stringdata) + ofs \
...
void QgsMessageBarItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QgsMessageBarItem::styleChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QgsMessageBarItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QgsMessageBarItem.data,
      qt_meta_data_QgsMessageBarItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsMessageBarItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMessageBarItem.stringdata))
        return static_cast<void*>(const_cast< QgsMessageBarItem*>(this));
