...
#include "../../../SWGIS-Inc/SWGIS-Gui/qgsprevieweffect.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsPreviewEffect_t, stringdata) + ofs \
...
const QMetaObject QgsPreviewEffect::staticMetaObject = {
    { &QGraphicsEffect::staticMetaObject, qt_meta_stringdata_QgsPreviewEffect.data,
      qt_meta_data_QgsPreviewEffect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsPreviewEffect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsPreviewEffect.stringdata))
        return static_cast<void*>(const_cast< QgsPreviewEffect*>(this));
