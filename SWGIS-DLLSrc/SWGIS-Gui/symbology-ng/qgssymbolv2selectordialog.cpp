        ...
        else
        {
          switch ( mSymbol->type() )
          {
            case QgsSymbolV2::Marker :
              return QCoreApplication::translate( "SymbolLayerItem", "Marker", nullptr);
            case QgsSymbolV2::Fill   :
              return QCoreApplication::translate( "SymbolLayerItem", "Fill", nullptr);
            case QgsSymbolV2::Line   :
              return QCoreApplication::translate( "SymbolLayerItem", "Line", nullptr);
            default:
              return "Symbol";
          }
        }
