...
#endif
{
  ...
  if ( mWKBType == QGis::WKBUnknown )
  {
    ...
    QUrlQuery urlQuery(typeDetectionUri);
    urlQuery.removeQueryItem( "BBOX" );
    urlQuery.addQueryItem( "MAXFEATURES", "1" );
    typeDetectionUri.setQuery(urlQuery);
...
int QgsWFSProvider::getFeatureGET( const QString& uri, const QString& geometryAttribute )
{
  ...
  urlQuery.removeQueryItem( "authcfg" );
...
int QgsWFSProvider::describeFeatureTypeGET( const QString& uri, QString& geometryAttribute, QgsFields& fields, QGis::WkbType& geomType )
{
  ...
  QUrlQuery urlQuery(describeFeatureUrl);
  urlQuery.removeQueryItem( "username" );
  urlQuery.removeQueryItem( "password" );
  urlQuery.removeQueryItem( "authcfg" );
  ...
  describeFeatureUrl.setQuery(urlQuery);
...
bool QgsWFSProvider::sendTransactionDocument( const QDomDocument& doc, QDomDocument& serverResponse )
{
  ...
  urlQuery.removeQueryItem( "FEATUREID" );
  urlQuery.removeQueryItem( "PROPERTYNAME" );
  urlQuery.removeQueryItem( "MAXFEATURES" );
  urlQuery.removeQueryItem( "OUTPUTFORMAT" );
  typeDetectionUri.setQuery(urlQuery);
...
void QgsWFSProvider::getLayerCapabilities()
{
  ...
  QUrlQuery urlQuery(getCapabilitiesUrl);
  urlQuery.removeQueryItem( "username" );
  urlQuery.removeQueryItem( "password" );
  urlQuery.removeQueryItem( "authcfg" );
  getCapabilitiesUrl.setQuery(urlQuery);
