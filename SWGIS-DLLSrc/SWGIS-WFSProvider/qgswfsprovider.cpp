...
QDomElement QgsWFSProvider::createTransactionElement( QDomDocument& doc ) const
{
  ...
  QUrlQuery urlQuery(describeFeatureTypeURL);
  urlQuery.addQueryItem( "REQUEST", "DescribeFeatureType" );
  urlQuery.addQueryItem( "VERSION", "1.0.0" );
  urlQuery.addQueryItem( "TYPENAME", mShared->mURI.typeName() );
  describeFeatureTypeURL.setQuery(urlQuery);
