...
{
  SWGISNewHttpConnection* nc = new SWGISNewHttpConnection( this, QgsWFSConstants::CONNECTIONS_WFS );
...
{
  SWGISNewHttpConnection* nc = new SWGISNewHttpConnection( this, QgsWFSConstants::CONNECTIONS_WFS, cmbConnections->currentText() );
  nc->setAttribute( Qt::WA_DeleteOnClose );
