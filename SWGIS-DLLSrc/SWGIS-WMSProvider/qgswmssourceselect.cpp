...
{
  SWGISNewHttpConnection *nc = new SWGISNewHttpConnection( this );
...
{
  SWGISNewHttpConnection *nc = new SWGISNewHttpConnection( this, "/Qgis/connections-wms/", cmbConnections->currentText() );
