...
#include "../../../SWGIS-Inc/SWGIS-WMSProvider/qgstilescalewidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsTileScaleWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 65, 23), // "on_mSlider_valueChanged"
QT_MOC_LITERAL(7, 89, 12) // "scaleEnabled"

    },
    "QgsTileScaleWidget\0layerChanged\0\0"
    "QgsMapLayer*\0layer\0scaleChanged\0"
    "on_mSlider_valueChanged\0scaleEnabled"
};
...
void QgsTileScaleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_mSlider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject QgsTileScaleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QgsTileScaleWidget.data,
      qt_meta_data_QgsTileScaleWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QgsTileScaleWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsTileScaleWidget.stringdata))
        return static_cast<void*>(const_cast< QgsTileScaleWidget*>(this));
