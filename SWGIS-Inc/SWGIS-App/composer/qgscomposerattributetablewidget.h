...
#include "ui_swgiscomposerattributetablewidgetbase.h"
#include "qgscomposeritemwidget.h"

class QgsComposerAttributeTableV2;
class QgsComposerFrame;

class QgsComposerAttributeTableWidget: public QgsComposerItemBaseWidget, private Ui::ComposerAttributeTableWidgetBase
{
    Q_OBJECT
  public:
