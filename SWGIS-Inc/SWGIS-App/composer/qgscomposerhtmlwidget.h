...
#include "ui_swgiscomposerhtmlwidgetbase.h"
...
class QgsComposerHtmlWidget: public QgsComposerItemBaseWidget, private Ui::ComposerHtmlWidgetBase
{
    Q_OBJECT
  public:
  ...
  private:
    ...
    QLineEdit *mHtmlEditor;
    QLineEdit *mStylesheetEditor;
};
