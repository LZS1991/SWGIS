...
#include "ui_swgisattributeactionpropertiesdialogbase.h"

#include "qgsaction.h"

#include <QDialog>

class QgsAttributeActionPropertiesDialog: public QDialog, private Ui::AttributeActionPropertiesDialogBase
{
    Q_OBJECT
