...
#include <ui_swgisbrowserpropertiesdialogbase.h>
...
class QgsBrowserLayerProperties : public QgsBrowserPropertiesWidget, private Ui::BrowserLayerPropertiesBase
{
    Q_OBJECT
  public:
...
class QgsBrowserDirectoryProperties : public QgsBrowserPropertiesWidget , private Ui::BrowserDirectoryPropertiesBase
{
    Q_OBJECT
  public:
...
class QgsBrowserPropertiesDialog : public QDialog , private Ui::BrowserPropertiesDialogBase
{
    Q_OBJECT
  public:
