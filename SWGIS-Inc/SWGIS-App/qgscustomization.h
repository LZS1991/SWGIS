...
#include "ui_swgiscustomizationdialogbase.h"
...
class SWGISAPP_EXPORT QgsCustomizationDialog : public QMainWindow, private Ui::CustomizationDialogBase
{
    Q_OBJECT
  public:
...
class SWGISAPP_EXPORT QgsCustomization : public QObject
{
    Q_OBJECT
