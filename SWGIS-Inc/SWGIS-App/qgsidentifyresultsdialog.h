...
#include "ui_swgisidentifyresultsbase.h"
...
class SWGISAPP_EXPORT QgsIdentifyResultsWebView : public QgsWebView
{
    Q_OBJECT
  public:
...
class SWGISAPP_EXPORT QgsIdentifyResultsFeatureItem: public QTreeWidgetItem
{
  public:
...
class SWGISAPP_EXPORT QgsIdentifyResultsWebViewItem: public QObject, public QTreeWidgetItem
{
    Q_OBJECT
...
class SWGISAPP_EXPORT QgsIdentifyPlotCurve
{
  public:
...
class SWGISAPP_EXPORT QgsIdentifyResultsDialog: public QDialog, private Ui::IdentifyResultsBase
{
    Q_OBJECT
