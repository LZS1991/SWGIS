...
#include "ui_swgisrasterlayerpropertiesbase.h"
#include "qgisgui.h"
...
class SWGISAPP_EXPORT QgsRasterLayerProperties : public QgsOptionsDialogBase, private Ui::RasterLayerPropertiesBase
{
    Q_OBJECT
