...
#include "ui_swgisvectorlayerpropertiesbase.h"
#include "qgisgui.h"
...
class SWGISAPP_EXPORT QgsVectorLayerProperties : public QgsOptionsDialogBase, private Ui::VectorLayerPropertiesBase
{
    Q_OBJECT
