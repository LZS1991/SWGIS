...
class SWGISCORE_EXPORT QgsComposerAttributeTableColumnModel: public QAbstractTableModel
{
    Q_OBJECT
...
class SWGISCORE_EXPORT QgsComposerTableSortColumnsProxyModel: public QSortFilterProxyModel
{
    Q_OBJECT
