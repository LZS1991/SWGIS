...
class SWGISCORE_EXPORT QgsComposerAttributeTableColumnModelV2: public QAbstractTableModel
{
    Q_OBJECT
...
class SWGISCORE_EXPORT QgsComposerTableSortColumnsProxyModelV2: public QSortFilterProxyModel
{
    Q_OBJECT
