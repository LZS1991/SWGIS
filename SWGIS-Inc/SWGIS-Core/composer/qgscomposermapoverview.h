 ...
 */
class SWGISCORE_EXPORT QgsComposerMapOverviewStack : public QgsComposerMapItemStack
{
  public:
 ...
 */
class SWGISCORE_EXPORT QgsComposerMapOverview : public QgsComposerMapItem
{
    Q_OBJECT
