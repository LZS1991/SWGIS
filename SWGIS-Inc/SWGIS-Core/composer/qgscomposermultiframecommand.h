...
class SWGISCORE_EXPORT QgsComposerMultiFrameCommand: public QUndoCommand
{
  public:
...
class SWGISCORE_EXPORT QgsComposerMultiFrameMergeCommand: public QgsComposerMultiFrameCommand
{
  public:
    enum Context
    {
