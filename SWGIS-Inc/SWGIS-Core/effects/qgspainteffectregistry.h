 ...
 */
class SWGISCORE_EXPORT QgsPaintEffectAbstractMetadata
{
  public:
 ...
 * \note Added in version 2.9
 */
class SWGISCORE_EXPORT QgsPaintEffectMetadata : public QgsPaintEffectAbstractMetadata
{
 ...
 * \note Added in version 2.9
 */
class SWGISCORE_EXPORT QgsPaintEffectRegistry
{
  public:
