...
class SWGISCORE_EXPORT QgsShadowEffect : public QgsPaintEffect
{
 ...
 * \note Added in version 2.9
 */
class SWGISCORE_EXPORT QgsDropShadowEffect : public QgsShadowEffect
{
 ...
 * \note Added in version 2.9
 */
class SWGISCORE_EXPORT QgsInnerShadowEffect : public QgsShadowEffect
{
