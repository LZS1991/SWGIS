...
class SWGISCORE_EXPORT QgsGeometry
{
  public:
    //! Constructor
    QgsGeometry();
...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsGeometry& geometry );
/** Reads a geometry from stream in into geometry. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsGeometry& geometry );
