 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsLayerTreeModelLegendNode : public QObject
{
    Q_OBJECT
  public:
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsSymbolV2LegendNode : public QgsLayerTreeModelLegendNode
{
    Q_OBJECT
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsSimpleLegendNode : public QgsLayerTreeModelLegendNode
{
    Q_OBJECT
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsImageLegendNode : public QgsLayerTreeModelLegendNode
{
    Q_OBJECT
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsRasterSymbolLegendNode : public QgsLayerTreeModelLegendNode
{
    Q_OBJECT
 ...
 * @note added in 2.8
 */
class SWGISCORE_EXPORT QgsWMSLegendNode : public QgsLayerTreeModelLegendNode
{
    Q_OBJECT
