...
SWGISCORE_EXPORT bool qgsVariantLessThan( const QVariant& lhs, const QVariant& rhs );

//! Compares two QVariant values and returns whether the first is greater than the second.
//! Useful for sorting lists of variants, correctly handling sorting of the various
//! QVariant data types (such as strings, numeric values, dates and times)
//! @see qgsVariantLessThan()
SWGISCORE_EXPORT bool qgsVariantGreaterThan( const QVariant& lhs, const QVariant& rhs );

SWGISCORE_EXPORT QString qgsVsiPrefix( const QString& path );

/** Allocates size bytes and returns a pointer to the allocated  memory.
    Works like C malloc() but prints debug message by QgsLogger if allocation fails.
    @param size size in bytes
 */
void SWGISCORE_EXPORT *qgsMalloc( size_t size );
 ...
 */
void SWGISCORE_EXPORT *qgsCalloc( size_t nmemb, size_t size );

/** Frees the memory space  pointed  to  by  ptr. Works like C free().
    @param ptr pointer to memory space
 */
void SWGISCORE_EXPORT qgsFree( void *ptr );

/** Wkt string that represents a geographic coord sys
 * @note added to replace GEOWkt
 */
extern SWGISCORE_EXPORT const QString GEOWKT;
extern SWGISCORE_EXPORT const QString PROJECT_SCALES;

/** PROJ4 string that represents a geographic coord sys */
extern SWGISCORE_EXPORT const QString GEOPROJ4;
...
extern SWGISCORE_EXPORT const QString GEO_EPSG_CRS_AUTHID;
...
extern SWGISCORE_EXPORT const QString GEO_NONE;
