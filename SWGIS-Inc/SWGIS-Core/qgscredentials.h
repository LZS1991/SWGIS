...
*/
class SWGISCORE_EXPORT QgsCredentials
{
  public:
    //! virtual destructor
...
*/
class SWGISCORE_EXPORT QgsCredentialsNone : public QObject, public QgsCredentials
{
    Q_OBJECT
...
GUI.
*/
class SWGISCORE_EXPORT QgsCredentialsConsole : public QObject, public QgsCredentials
{
    Q_OBJECT
