...
class SWGISCORE_EXPORT QgsAnimatedIcon : public QObject
{
    Q_OBJECT
  public:
...
class SWGISCORE_EXPORT QgsDataItem : public QObject
{
    Q_OBJECT
    Q_ENUMS( Type )
    Q_ENUMS( State )
...
class SWGISCORE_EXPORT QgsLayerItem : public QgsDataItem
{
    Q_OBJECT
  public:
    enum LayerType
...
class SWGISCORE_EXPORT QgsDataCollectionItem : public QgsDataItem
{
    Q_OBJECT
  public:
...
class SWGISCORE_EXPORT QgsDirectoryItem : public QgsDataCollectionItem
{
    Q_OBJECT
  public:
    enum Column
 ...
 */
class SWGISCORE_EXPORT QgsProjectItem : public QgsDataItem
{
    Q_OBJECT
  public:
 ...
 */
class SWGISCORE_EXPORT QgsErrorItem : public QgsDataItem
{
    Q_OBJECT
  public:
...
class SWGISCORE_EXPORT QgsDirectoryParamWidget : public QTreeWidget
{
    Q_OBJECT
...
class SWGISCORE_EXPORT QgsFavouritesItem : public QgsDataCollectionItem
{
    Q_OBJECT
  public:
...
class SWGISCORE_EXPORT QgsZipItem : public QgsDataCollectionItem
{
    Q_OBJECT
