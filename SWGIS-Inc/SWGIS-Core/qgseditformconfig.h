 ...
 * layer.
 */
class SWGISCORE_EXPORT QgsAttributeEditorElement : public QObject
{
    Q_OBJECT
  public:
 ...
 */
class SWGISCORE_EXPORT QgsAttributeEditorContainer : public QgsAttributeEditorElement
{
    Q_OBJECT
 ...
 */
class SWGISCORE_EXPORT QgsAttributeEditorField : public QgsAttributeEditorElement
{
    Q_OBJECT
 ...
 */
class SWGISCORE_EXPORT QgsAttributeEditorRelation : public QgsAttributeEditorElement
{
    Q_OBJECT
...
class SWGISCORE_EXPORT QgsEditFormConfig : public QObject
{
    Q_OBJECT
