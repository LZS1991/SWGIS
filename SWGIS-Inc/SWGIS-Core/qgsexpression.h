...
class SWGISCORE_EXPORT QgsExpression
{
  ...
  public:
    ...
    /** \ingroup core
      ...
      */
    class SWGISCORE_EXPORT Parameter
    {
      public:
    ...
    /** \ingroup core
      ...
      */
    class SWGISCORE_EXPORT Function
    {
      public:
    ...
    //! @note added in QGIS 2.16
    //! \ingroup core
    class SWGISCORE_EXPORT NamedNode
    {
      public:
    ...
    class SWGISCORE_EXPORT WhenThen
    {
      public:
    ...
    class SWGISCORE_EXPORT NodeCondition : public Node
    {
      public:
