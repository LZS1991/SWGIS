...
class SWGISCORE_EXPORT QgsScopedExpressionFunction : public QgsExpression::Function
{
  public:
...
class SWGISCORE_EXPORT QgsExpressionContextScope
{
  public:
 ...
 * \note added in QGIS 2.12
 */
class SWGISCORE_EXPORT QgsExpressionContext
{
  public:
...
class SWGISCORE_EXPORT QgsExpressionContextUtils
{
  public:
