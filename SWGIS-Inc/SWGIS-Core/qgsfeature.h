...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsFeatureId& featureId );
/** Reads a feature id from stream in into feature id. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsFeatureId& featureId );
 ...
 */
class SWGISCORE_EXPORT QgsAttributes : public QVector<QVariant>
{
  public:
    QgsAttributes()
        : QVector<QVariant>()
 ...
 */
class SWGISCORE_EXPORT QgsFeature
{
  public:
...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsFeature& feature );
/** Reads a feature from stream in into feature. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsFeature& feature );
