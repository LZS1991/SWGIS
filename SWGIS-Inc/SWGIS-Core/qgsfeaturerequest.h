 ...
 *
 */
class SWGISCORE_EXPORT QgsFeatureRequest
{
  public:
    enum Flag
    {
     ...
     */
    class SWGISCORE_EXPORT OrderByClause
    {
      public:
        /**
    ...
    class OrderBy : public QList<OrderByClause>
    {
      public:
         ...
         */
        SWGISCORE_EXPORT OrderBy( const QList<OrderByClause>& other );
         ...
         */
        QList<OrderByClause> SWGISCORE_EXPORT list() const;

        /**
         * Serialize to XML
         */
        void SWGISCORE_EXPORT save( QDomElement& elem ) const;

        /**
         * Deserialize from XML
         */
        void SWGISCORE_EXPORT load( const QDomElement& elem );

        /**
         * Returns a set of used attributes
         */
        QSet<QString> SWGISCORE_EXPORT usedAttributes() const;

        /**
         * Dumps the content to an SQL equivalent syntax
         */
        QString SWGISCORE_EXPORT dump() const;
    };
 ...
 * @note added in 2.4
 */
class SWGISCORE_EXPORT QgsAbstractFeatureSource
{
  public:
