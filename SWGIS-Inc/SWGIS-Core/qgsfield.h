...
class SWGISCORE_EXPORT QgsField
{
  public:
...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsField& field );
/** Reads a field from stream in into field. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsField& field );
 ...
 */
class SWGISCORE_EXPORT QgsFields
{
  public:
    ...
    class iterator
    {
      public:
        ...
        inline bool operator==( const iterator &o ) const { return d == o.d; }
        inline bool operator!=( const iterator &o ) const  { return d != o.d; }
        inline bool operator<( const iterator& other ) const  { return d < other.d; }
        inline bool operator<=( const iterator& other ) const  { return d <= other.d; }
        inline bool operator>( const iterator& other ) const  { return d > other.d; }
        inline bool operator>=( const iterator& other ) const  { return d >= other.d; }
    ...
    class const_iterator
    {
      public:
        ...
        inline const QgsField* operator->() const { return &d->field; }
        inline const QgsField& operator[]( difference_type j ) const  { return d[j].field; }
        inline bool operator==( const const_iterator &o ) const  { return d == o.d; }
        inline bool operator!=( const const_iterator &o ) const  { return d != o.d; }
        inline bool operator<( const const_iterator& other ) const  { return d < other.d; }
        inline bool operator<=( const const_iterator& other ) const  { return d <= other.d; }
        inline bool operator>( const const_iterator& other ) const  { return d > other.d; }
        inline bool operator>=( const const_iterator& other ) const  { return d >= other.d; }
...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsFields& fields );
/** Reads fields from stream in into fields. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsFields& fields );
