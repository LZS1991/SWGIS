...
class SWGISCORE_EXPORT QgsInterval
{
  public:
 ...
 */
QgsInterval SWGISCORE_EXPORT operator-( const QDateTime& datetime1, const QDateTime& datetime2 );
 ...
 * @note not available in Python bindings
 */
QgsInterval SWGISCORE_EXPORT operator-( const QDate& date1, const QDate& date2 );
 ...
 * @note not available in Python bindings
 */
QgsInterval SWGISCORE_EXPORT operator-( const QTime& time1, const QTime& time2 );
 ...
 * @note not available in Python bindings
 */
QDateTime SWGISCORE_EXPORT operator+( const QDateTime& start, const QgsInterval& interval );
