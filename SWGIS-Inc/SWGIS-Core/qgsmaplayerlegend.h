 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsMapLayerLegend : public QObject
{
    Q_OBJECT
  public:
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsMapLayerLegendUtils
{
  public:
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsDefaultVectorLayerLegend : public QgsMapLayerLegend
{
    Q_OBJECT
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsDefaultRasterLayerLegend : public QgsMapLayerLegend
{
    Q_OBJECT
 ...
 * @note added in 2.6
 */
class SWGISCORE_EXPORT QgsDefaultPluginLayerLegend : public QgsMapLayerLegend
{
    Q_OBJECT
