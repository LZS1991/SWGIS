...
class SWGISCORE_EXPORT QgsLabelPosition
{
  public:
...
class SWGISCORE_EXPORT QgsLabelingEngineInterface
{
  public:
...
struct SWGISCORE_EXPORT QgsLayerCoordinateTransform
{
  QString srcAuthId;
  QString destAuthId;
...
class SWGISCORE_EXPORT QgsMapRenderer : public QObject
{
    Q_OBJECT
