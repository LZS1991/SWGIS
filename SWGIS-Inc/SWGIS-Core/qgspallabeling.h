...
class SWGISCORE_EXPORT QgsPalLayerSettings
{
  public:
    QgsPalLayerSettings();
...
class SWGISCORE_EXPORT QgsLabelCandidate
{
  public:
...
/** \ingroup core
  ...
  */
class SWGISCORE_EXPORT QgsLabelComponent
{
  public:
    QgsLabelComponent()
        : mText( QString() )
 ...
 * @note added in 2.4
 */
class SWGISCORE_EXPORT QgsLabelingResults
{
  public:
    QgsLabelingResults();
    ~QgsLabelingResults();
...
class SWGISCORE_EXPORT QgsPalLabeling : public QgsLabelingEngineInterface
{
  public:
    enum DrawLabelType
    {
