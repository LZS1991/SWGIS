...
class SWGISCORE_EXPORT QgsProject : public QObject
{
    Q_OBJECT
...
class SWGISCORE_EXPORT QgsProjectBadLayerHandler
{
  public:
...
class SWGISCORE_EXPORT QgsProjectBadLayerDefaultHandler : public QgsProjectBadLayerHandler
{
  public:
 ...
 */
SWGISCORE_EXPORT QgsProjectVersion getVersion( QDomDocument const &doc );
