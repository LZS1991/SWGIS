 ...
 */
class SWGISCORE_EXPORT QgsRectangle
{
  public:
    //! Constructor
...
SWGISCORE_EXPORT QDataStream& operator<<( QDataStream& out, const QgsRectangle& rectangle );
/** Reads a rectangle from stream in into rectangle. QGIS version compatibility is not guaranteed. */
SWGISCORE_EXPORT QDataStream& operator>>( QDataStream& in, QgsRectangle& rectangle );
