...
class SWGISCORE_EXPORT QgsRuleBasedLabeling : public QgsAbstractVectorLayerLabeling
{
  public:
    class Rule;
 ...
 * @note this class is not a part of public API yet. See notes in QgsLabelingEngineV2
 */
class SWGISCORE_EXPORT QgsRuleBasedLabelProvider : public QgsVectorLayerLabelProvider
{
  public:
