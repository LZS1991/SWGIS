...
class SWGISCORE_EXPORT QgsRendererRangeV2
{
  public:
    QgsRendererRangeV2();
...
// @note added in 2.6
class SWGISCORE_EXPORT QgsRendererRangeV2LabelFormat
{
  public:
...
class SWGISCORE_EXPORT QgsGraduatedSymbolRendererV2 : public QgsFeatureRendererV2
{
  public:
