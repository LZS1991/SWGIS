...
#include "ui_swgisdualviewbase.h"
 ...
 */
class SWGISGUI_EXPORT QgsDualView : public QStackedWidget, private Ui::DualViewBase
{
    Q_OBJECT
    Q_ENUMS( ViewMode )
...
class SWGISGUI_EXPORT QgsAttributeTableAction : public QAction
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsAttributeTableMapLayerAction : public QAction
{
    Q_OBJECT
