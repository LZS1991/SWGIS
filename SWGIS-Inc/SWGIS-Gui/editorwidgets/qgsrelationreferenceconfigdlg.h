...
#include "ui_swgisrelationreferenceconfigdlgbase.h"
...
class SWGISGUI_EXPORT QgsRelationReferenceConfigDlg : public QgsEditorConfigWidget, private Ui::RelReferenceConfigDlgBase
{
    Q_OBJECT
