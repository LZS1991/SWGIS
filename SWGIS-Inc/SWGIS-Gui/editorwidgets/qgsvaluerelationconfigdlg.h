...
#include "ui_swgisvaluerelationconfigdlgbase.h"
...
class SWGISGUI_EXPORT QgsValueRelationConfigDlg : public QgsEditorConfigWidget, private Ui::ValueRelationConfigDlgBase
{
    Q_OBJECT
