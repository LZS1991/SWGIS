...
#include "ui_swgislayertreeembeddedconfigwidget.h"
 ...
 */
class SWGISGUI_EXPORT QgsLayerTreeEmbeddedConfigWidget : public QWidget, protected Ui::LayerTreeEmbeddedConfigWidget
{
    Q_OBJECT
  public:
    /**
