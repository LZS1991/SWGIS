...
namespace QgisGui
{
  ...
  */
  ...
  bool SWGISGUI_EXPORT openFilesRememberingFilter( QString const &filterName,
   ...
   * the file type
   */
  QPair<QString, QString> SWGISGUI_EXPORT getSaveAsImageName( QWidget * theParent, const QString& theMessage, const QString& defaultFilename = QString::null );
  ...
  /**
    ...
    case versions added.
  */
  QString SWGISGUI_EXPORT createFileFilter_( QString const &longName, QString const &glob );
   ...
   */
  QString SWGISGUI_EXPORT createFileFilter_( QString const &format );
   ...
   */
  QFont SWGISGUI_EXPORT getFont( bool &ok, const QFont &initial, const QString &title = QString() );
}
