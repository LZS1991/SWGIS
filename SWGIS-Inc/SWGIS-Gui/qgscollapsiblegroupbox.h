...
class SWGISGUI_EXPORT QgsGroupBoxCollapseButton : public QToolButton
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsCollapsibleGroupBoxBasic : public QGroupBox
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsCollapsibleGroupBox : public QgsCollapsibleGroupBoxBasic
{
    Q_OBJECT
