...
class SWGISGUI_EXPORT QgsColorDialog : public QObject
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsColorDialogV2 : public QDialog, private Ui::ColorDialogBase
{
...
//                      const QColor& color = QColor() );
    ...
    QgsColorDialogV2( QWidget *parent = nullptr, const Qt::WindowFlags& fl = nullptr,
                      const QColor& color = QColor() );
