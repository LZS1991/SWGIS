 ...
 */
class SWGISGUI_EXPORT QgsColorSwatchDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
 ...
 * @note introduced in QGIS 2.5
 */
class SWGISGUI_EXPORT QgsColorSchemeModel: public QAbstractItemModel
{
    Q_OBJECT
 ...
 * @note introduced in QGIS 2.5
 */
class SWGISGUI_EXPORT QgsColorSchemeList: public QTreeView
{
    Q_OBJECT
