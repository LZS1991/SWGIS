...
#include <../../SWGIS-Build/SWGIS-Gui/ui_swgiscredentialdialog.h>
//#include <qgisgui.h>
 ...
 */
class SWGISGUI_EXPORT QgsCredentialDialog : public QDialog, public QgsCredentials, private Ui_CredentialDialog
{
    Q_OBJECT
  public:
    QgsCredentialDialog( QWidget *parent = nullptr, const Qt::WindowFlags& fl = nullptr );
    ~QgsCredentialDialog();
