...
#include "../../SWGIS-Build/SWGIS-Gui/ui_swgisexpressionbuilderdialogbase.h"
#include "stgisguiconfig.h"
/** A generic dialog for building expression strings
  * @remarks This class also shows an example on how to use QgsExpressionBuilderWidget
  */
class SWGISGUI_EXPORT QgsExpressionBuilderDialog : public QDialog, private Ui::ExpressionBuilderDialogBase
{
    Q_OBJECT
