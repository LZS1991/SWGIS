...
#include <QWidget>
#include "../../SWGIS-Build/SWGIS-Gui/ui_swgisexpressionbuilder.h"
...
/** Search proxy used to filter the QgsExpressionBuilderWidget tree.
  ...
  * level down
  */
class SWGISGUI_EXPORT QgsExpressionItemSearchProxy : public QSortFilterProxyModel
{
    Q_OBJECT
...
/** A reusable widget that can be used to build a expression string.
  ...
  */
class SWGISGUI_EXPORT QgsExpressionBuilderWidget : public QWidget, private Ui::ExpressionBuilderWidgetBase
{
    Q_OBJECT
  public:
