...
#include "ui_swgisexpressionselectiondialogbase.h"
 ...
 */
class SWGISGUI_EXPORT QgsExpressionSelectionDialog : public QDialog, private Ui::ExpressionSelectionDialogBase
{
    Q_OBJECT
