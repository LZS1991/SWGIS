...
#include "ui_swgisrasterpyramidsoptionswidgetbase.h"
 ...
 */
class SWGISGUI_EXPORT QgsRasterPyramidsOptionsWidget: public QWidget,
      private Ui::RasterPyramidsOptionsWidgetBase
{
    Q_OBJECT
