...
#include "ui_swgissqlcomposerdialogbase.h"
#include <qgis.h>
#include <qgisgui.h>
 ...
 */
class SWGISGUI_EXPORT QgsSQLComposerDialog : public QDialog, private Ui::SQLComposerDialogBase
{
    Q_OBJECT
  ...
  public:
     ...
     * @note not available in Python bindings
     */
    class SWGISGUI_EXPORT TableSelectedCallback
    {
      public:
     ...
     * @note not available in Python bindings
     */
    class SWGISGUI_EXPORT SQLValidatorCallback
    {
      public:
