...
#include "ui_swgisunitselectionwidget.h"
#include "ui_swgismapunitscaledialog.h"
#include "stgisguiconfig.h"

class QgsMapCanvas;

/** Dialog allowing the user to choose the minimum and maximum scale of an object in map units */
class SWGISGUI_EXPORT QgsMapUnitScaleDialog : public QDialog, private Ui::MapUnitScaleDialog
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsUnitSelectionWidget : public QWidget, private Ui::UnitSelectionWidget
{
    Q_OBJECT
