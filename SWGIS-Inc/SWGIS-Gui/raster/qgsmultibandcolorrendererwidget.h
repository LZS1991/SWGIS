...
#include "ui_swgismultibandcolorrendererwidgetbase.h"
...
class SWGISGUI_EXPORT QgsMultiBandColorRendererWidget: public QgsRasterRendererWidget, private Ui::MultiBandColorRendererWidgetBase
{
    Q_OBJECT
