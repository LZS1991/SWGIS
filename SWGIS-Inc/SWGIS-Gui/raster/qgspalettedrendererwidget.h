...
#include "ui_swgispalettedrendererwidgetbase.h"
#include "stgisguiconfig.h"
class QgsRasterLayer;

class SWGISGUI_EXPORT QgsPalettedRendererWidget: public QgsRasterRendererWidget, private Ui::PalettedRendererWidgetBase
{
    Q_OBJECT
