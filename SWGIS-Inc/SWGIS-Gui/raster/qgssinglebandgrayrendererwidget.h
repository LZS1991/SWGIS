...
#include "ui_swgissinglebandgrayrendererwidgetbase.h"
#include "stgisguiconfig.h"
class SWGISGUI_EXPORT QgsSingleBandGrayRendererWidget: public QgsRasterRendererWidget, private Ui::SingleBandGrayRendererWidgetBase
{
    Q_OBJECT
  public:
