...
#include "ui_swgissinglebandpseudocolorrendererwidgetbase.h"

class SWGISGUI_EXPORT QgsSingleBandPseudoColorRendererWidget: public QgsRasterRendererWidget,
      private Ui::SingleBandPseudoColorRendererWidgetBase
{
    Q_OBJECT
  public:
    enum Mode
 ...
 */
class SWGISGUI_EXPORT QgsTreeWidgetItem: public QObject, public QTreeWidgetItem
{
    Q_OBJECT
  public:
