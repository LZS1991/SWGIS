...
#include "ui_swgisarrowsymbollayerwidgetbase.h"
 ...
 */
class SWGISGUI_EXPORT QgsArrowSymbolLayerWidget: public QgsSymbolLayerV2Widget, private Ui::ArrowSymbolLayerWidgetBase
{
    Q_OBJECT
