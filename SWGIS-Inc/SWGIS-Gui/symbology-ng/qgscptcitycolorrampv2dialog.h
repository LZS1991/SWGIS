...
#include "ui_swgiscptcitycolorrampv2dialogbase.h"
#include <QDialog>
...
class SWGISGUI_EXPORT QgsCptCityColorRampV2Dialog : public QDialog, private Ui::CptCityColorRampV2DialogBase
{
    Q_OBJECT
