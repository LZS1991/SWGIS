...
#include "ui_swgisgraduatedsymbolrendererv2widget.h"

/// @cond PRIVATE

class SWGISGUI_EXPORT QgsGraduatedSymbolRendererV2Model : public QAbstractItemModel
{
    Q_OBJECT
  public:
...
class SWGISGUI_EXPORT QgsGraduatedSymbolRendererV2Widget : public QgsRendererV2Widget, private Ui::GraduatedSymbolRendererV2Widget
{
    Q_OBJECT
