...
#include "ui_swgisheatmaprendererwidgetbase.h"
#include "qgsheatmaprenderer.h"
#include "qgsrendererv2widget.h"

class QMenu;

class SWGISGUI_EXPORT QgsHeatmapRendererWidget : public QgsRendererV2Widget, private Ui::HeatmapRendererWidgetBase
{
    Q_OBJECT
