...
#include "ui_swgisinvertedpolygonrendererwidgetbase.h"
 ...
 * @note added in 2.4
 */
class SWGISGUI_EXPORT QgsInvertedPolygonRendererWidget : public QgsRendererV2Widget, private Ui::InvertedPolygonRendererWidgetBase
{
    Q_OBJECT
