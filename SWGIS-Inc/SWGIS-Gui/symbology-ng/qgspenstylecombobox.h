...
class SWGISGUI_EXPORT QgsPenStyleComboBox : public QComboBox
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsPenJoinStyleComboBox : public QComboBox
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsPenCapStyleComboBox : public QComboBox
{
    Q_OBJECT
