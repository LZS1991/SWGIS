...
#include "ui_swgispointdisplacementrendererwidgetbase.h"
#include "qgsrendererv2widget.h"

class QgsPointDisplacementRenderer;

class SWGISGUI_EXPORT QgsPointDisplacementRendererWidget: public QgsRendererV2Widget, private Ui::PointDisplacementRendererWidgetBase
{
    Q_OBJECT
  public:
