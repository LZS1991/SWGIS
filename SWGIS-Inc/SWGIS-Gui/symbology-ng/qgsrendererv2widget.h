...
*/
class SWGISGUI_EXPORT QgsDataDefinedValueDialog : public QDialog, public Ui::DataDefinedValueDialog
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsDataDefinedSizeDialog : public QgsDataDefinedValueDialog
{
    Q_OBJECT
  public:
...
class SWGISGUI_EXPORT QgsDataDefinedRotationDialog : public QgsDataDefinedValueDialog
{
    Q_OBJECT
  public:
...
class SWGISGUI_EXPORT QgsDataDefinedWidthDialog : public QgsDataDefinedValueDialog
{
    Q_OBJECT
  public:
