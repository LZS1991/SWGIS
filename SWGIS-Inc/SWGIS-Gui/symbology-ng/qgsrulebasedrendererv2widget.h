...
(invalid)  == root node
 ...
 +--- top level rule
*/
class SWGISGUI_EXPORT QgsRuleBasedRendererV2Model : public QAbstractItemModel
{
    Q_OBJECT
...
#include "ui_swgisrulebasedrendererv2widget.h"

class SWGISGUI_EXPORT QgsRuleBasedRendererV2Widget : public QgsRendererV2Widget, private Ui::RuleBasedRendererV2Widget
{
    Q_OBJECT
...
#include "ui_swgisrendererrulepropsdialogbase.h"
#include "qgssymbolv2selectordialog.h"

class SWGISGUI_EXPORT QgsRendererRulePropsWidget : public QgsPanelWidget, private Ui::RendererRulePropsWidget
{
    Q_OBJECT
 ...
 */
class SWGISGUI_EXPORT QgsRendererRulePropsDialog : public QDialog
{
    Q_OBJECT
