...
#include "ui_swgissmartgroupconditionwidget.h"
#include "stgisguiconfig.h"
class SWGISGUI_EXPORT QgsSmartGroupCondition : public QWidget, private Ui::SmartGroupConditionWidget
{
    Q_OBJECT
...
#include "ui_swgissmartgroupeditordialogbase.h"
//#include "qgscontexthelp.h"

#include "qgsstylev2.h" //for QgsSmartConditionMap

class SWGISGUI_EXPORT QgsSmartGroupEditorDialog : public QDialog, private Ui::SmartGroupEditorDialogBase
{
    Q_OBJECT
