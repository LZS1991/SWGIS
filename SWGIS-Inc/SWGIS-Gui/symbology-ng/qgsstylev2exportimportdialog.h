...
#include "ui_swgisstylev2exportimportdialogbase.h"
#include "stgisguiconfig.h"
class QgsStyleV2;

class SWGISGUI_EXPORT QgsStyleV2ExportImportDialog : public QDialog, private Ui::StyleV2ExportImportDialogBase
{
    Q_OBJECT
