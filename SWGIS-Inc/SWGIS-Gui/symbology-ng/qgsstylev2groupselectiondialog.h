...
#include "ui_swgisstylev2groupselectiondialogbase.h"
#include "stgisguiconfig.h"

class QgsStyleV2;

class SWGISGUI_EXPORT QgsStyleV2GroupSelectionDialog : public QDialog, private Ui::SymbolsV2GroupSelectionDialogBase
{
    Q_OBJECT
