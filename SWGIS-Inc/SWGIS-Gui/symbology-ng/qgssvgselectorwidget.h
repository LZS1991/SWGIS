...
class SWGISGUI_EXPORT QgsSvgSelectorListModel : public QAbstractListModel
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsSvgSelectorGroupsModel : public QStandardItemModel
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsSvgSelectorWidget : public QWidget, private Ui::WidgetSvgSelector
{
    Q_OBJECT
...
class SWGISGUI_EXPORT QgsSvgSelectorDialog : public QDialog
{
    Q_OBJECT
  public:
