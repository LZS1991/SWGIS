...
#include "ui_swgisvectorgradientcolorrampv2dialogbase.h"
...
class SWGISGUI_EXPORT QgsVectorGradientColorRampV2Dialog : public QDialog, private Ui::VectorGradientColorRampV2DialogBase
{
    Q_OBJECT
...
//
/// @cond PRIVATE
class SWGISGUI_EXPORT QgsGradientPlotEventFilter: public QObject
{
    Q_OBJECT
