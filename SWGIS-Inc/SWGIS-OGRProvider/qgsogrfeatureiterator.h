...
class SWGISOGRPROVIDER_EXPORT QgsOgrFeatureSource : public QgsAbstractFeatureSource
{
  public:
...
class SWGISOGRPROVIDER_EXPORT QgsOgrFeatureIterator : public QgsAbstractFeatureIteratorFromSource<QgsOgrFeatureSource>
{
  public:
