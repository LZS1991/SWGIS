 ...
 */
class SWGISOGRPROVIDER_EXPORT QgsOgrAbstractGeometrySimplifier
{
  public:
 ...
 */
class SWGISOGRPROVIDER_EXPORT QgsOgrTopologyPreservingSimplifier : public QgsOgrAbstractGeometrySimplifier, QgsTopologyPreservingSimplifier
{
  public:
 ...
 */
class SWGISOGRPROVIDER_EXPORT QgsOgrMapToPixelSimplifier : public QgsOgrAbstractGeometrySimplifier, QgsMapToPixelSimplifier
{
  public:
